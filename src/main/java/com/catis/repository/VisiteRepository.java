...
public interface VisiteRepository extends CrudRepository<Visite, Long> {
    ...
    List<Visite> findByActiveStatusTrueAndCarteGrise_NumImmatriculationContainingIgnoreCaseOrCarteGrise_Vehicule_ChassisContainingIgnoreCaseOrCaissier_Partenaire_NomContainingIgnoreCaseOrCarteGrise_ProprietaireVehicule_Partenaire_NomContainingIgnoreCase(String imma, String chassis, String caissier, String proprietaire, Pageable pageable);
